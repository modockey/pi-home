...
type GetAlbumsByIDHandlerFunc func(GetAlbumsByIDParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAlbumsByIDHandlerFunc) Handle(params GetAlbumsByIDParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// GetAlbumsByIDHandler interface for that can handle valid get albums by Id params
type GetAlbumsByIDHandler interface {
	Handle(GetAlbumsByIDParams, interface{}) middleware.Responder
}
...
/*
	GetAlbumsByID swagger:route GET /albums/{id} album getAlbumsById
