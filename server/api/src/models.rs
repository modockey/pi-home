...
impl std::string::ToString for GetIp200Response {
    ...
    fn try_from(hdr_value: header::IntoHeaderValue<GetIp200Response>) -> std::result::Result<Self, Self::Error> {
        ...
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             ...
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for GetIp200Response - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
             ...
             std::result::Result::Ok(value) => {
                    match <GetIp200Response as std::str::FromStr>::from_str(value) {
                        ...
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into GetIp200Response - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
