...
- API version: 1.0.0
- Build date: 2022-07-17T10:39:30.073517+09:00[Asia/Tokyo]
...
------------- | ------------- | -------------
[**getIP**](docs/ip_api.md#getIP) | **GET** /ip | Get Global IPv4 address of the system
